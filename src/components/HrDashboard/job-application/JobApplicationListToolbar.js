...
JobApplicationListToolbar.propTypes = {
  numSelected: PropTypes.number,
  filterName: PropTypes.string,
  onFilterName: PropTypes.func
};

export default function JobApplicationListToolbar({ numSelected, filterName, onFilterName }) {
  ...
  const AddJobApplicationSchema = Yup.object().shape({
    location: Yup.string()
      .min(2, "Too Short!")
      .max(50, "Too Long!")
  ...
  const formik = useFormik({
    ...
    validationSchema: AddJobApplicationSchema,
    onSubmit: (formValues) => {
