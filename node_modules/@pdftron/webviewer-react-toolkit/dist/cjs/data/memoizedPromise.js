...
var MemoizedPromise = /** @class */ (function () {
    function MemoizedPromise(futurableOrLazy, options) {
        ...
        this.get = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                if (this._done)
                    return [2 /*return*/, this._result];
                this._result = futurable_1.futureableOrLazyToFuturable(this._futurableOrLazy);
                this._done = true;
                return [2 /*return*/, this._result];
            });
        }); };
        if (futurableOrLazy instanceof MemoizedPromise) {
            this._futurableOrLazy = futurable_1.memoizedPromiseToFuturableOrLazy(futurableOrLazy);
        }
        else {
