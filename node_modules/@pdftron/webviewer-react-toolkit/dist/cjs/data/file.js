...
var File = /** @class */ (function () {
    ...
    function File(fileDetails) {
        ...
        this._generateThumbnail = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var result, e_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, utils_1.getThumbnail(this.fullDocumentObj || this.documentObj.get(), {
        ...
        this._generateFileObj = function () {
            return utils_1.documentToBlob(_this.documentObj.get());
        };
        /** Generate a document object from file object and extension. */
        this._generateDocumentObj = function () {
            return utils_1.blobToDocument(_this.fileObj.get(), _this.extension, _this._license);
        };
        var name = fileDetails.name, id = fileDetails.id, originalName = fileDetails.originalName, extension = fileDetails.extension, fileObj = fileDetails.fileObj, documentObj = fileDetails.documentObj, thumbnail = fileDetails.thumbnail, license = fileDetails.license, fullDocumentObj = fileDetails.fullDocumentObj, pageNumber = fileDetails.pageNumber;
        ...
        this._id = id || utils_1.getStringId('file');
        this._name = name;
        this._originalName = originalName || name;
        this._extension = extension || utils_1.getExtension(name);
        this._documentObj = new memoizedPromise_1.MemoizedPromise(documentObj !== null && documentObj !== void 0 ? documentObj : this._generateDocumentObj);
        this._fileObj = new memoizedPromise_1.MemoizedPromise(fileObj !== null && fileObj !== void 0 ? fileObj : this._generateFileObj);
        this._thumbnail = new memoizedPromise_1.MemoizedPromise(thumbnail !== null && thumbnail !== void 0 ? thumbnail : this._generateThumbnail);
    ...
    Object.defineProperty(File.prototype, "name", {
        ...
        set: function (name) {
            this._name = name;
            this._extension = utils_1.getExtension(name);
    ...
    File.prototype.updateDocumentObj = function (updater) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.documentObj.get()];
                    case 1:
                        documentObj = _a.sent();
    ...
    File.prototype.rotate = function (counterclockwise) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.getRotatedDocument(this.documentObj.get(), counterclockwise)];
                    case 1:
                        rotated = _a.sent();
    ...
    File.prototype.clone = function (overrides) {
        var _a = overrides || {}, documentObj = _a.documentObj, rest = tslib_1.__rest(_a, ["documentObj"]);
        return new File(tslib_1.__assign(tslib_1.__assign({ name: this.name, originalName: this.originalName, extension: this.extension }, rest), { documentObj: documentObj || utils_1.blobToDocument(utils_1.documentToBlob(this.documentObj.get()), this.extension, this._license) }));
    };
    /* --- Events. --- */
    /**
    ...
    File.prototype.subscribe = function (type, subscriber) {
        var _a;
        ((_a = this._subscribers[type]) !== null && _a !== void 0 ? _a : (this._subscribers[type] = [])).push(subscriber);
    ...
    File.prototype.dispatchEvent = function (type) {
        var _a;
        (_a = this._subscribers[type]) === null || _a === void 0 ? void 0 : _a.forEach(function (subscriber) { return subscriber(); });
        if (type !== 'onchange')
    ...
    File.prototype._unsubscribe = function (type, subscriber) {
        var _this = this;
        return function () { var _a; return (_this._subscribers[type] = (_a = _this._subscribers[type]) === null || _a === void 0 ? void 0 : _a.filter(function (l) { return l !== subscriber; })); };
    };
    return File;
}());
exports.File = File;
