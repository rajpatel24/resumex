...
exports.DragLayer = function (_a) {
    var children = _a.children, customTranslate = _a.customTranslate, className = _a.className, divProps = tslib_1.__rest(_a, ["children", "customTranslate", "className"]);
    var _b = react_dnd_1.useDragLayer(function (monitor) { return ({
    ...
    if (!isDragging)
        return null;
    var dragLayerClass = classnames_1.default('ui__base ui__dragLayer', className);
    return (react_1.default.createElement("div", tslib_1.__assign({}, divProps, { className: dragLayerClass }),
