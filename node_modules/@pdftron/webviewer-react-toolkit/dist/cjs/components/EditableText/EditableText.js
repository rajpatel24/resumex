...
exports.EditableText = react_1.forwardRef(function (_a, ref) {
    var controlledValue = _a.value, controlledEditMode = _a.editMode, onEdit = _a.onEdit, onSave = _a.onSave, onCancel = _a.onCancel, className = _a.className, disabled = _a.disabled, locked = _a.locked, onRenderText = _a.onRenderText, placeholder = _a.placeholder, centerText = _a.centerText, bordered = _a.bordered, clickableDivProps = tslib_1.__rest(_a, ["value", "editMode", "onEdit", "onSave", "onCancel", "className", "disabled", "locked", "onRenderText", "placeholder", "centerText", "bordered"]);
    var inputRef = react_1.useRef(null);
    var buttonRef = react_1.useRef(null);
    react_1.useImperativeHandle(ref, function () { return buttonRef.current; });
    // Use state if controlled edit mode not provided.
    var _b = react_1.useState(false), stateEditMode = _b[0], setStateEditMode = _b[1];
    ...
    var _c = react_1.useState(''), stateValue = _c[0], setStateValue = _c[1];
    ...
    var _d = react_1.useState(value), editValue = _d[0], setEditValue = _d[1];
    react_1.useEffect(function () { return setEditValue(value); }, [editMode, value]);
    var _e = react_1.useState(false), noFocusTransition = _e[0], setNoFocusTransition = _e[1];
    ...
    var editableTextClass = classnames_1.default('ui__base ui__editableText', {
    ...
    var buttonClass = classnames_1.default('ui__editableText__button', {
        'ui__editableText__button--placeholder': isPlaceholder,
        'ui__editableText__button--noFocusTransition': noFocusTransition,
    });
    var fieldClass = classnames_1.default('ui__editableText__field', {
        'ui__editableText__field--tabbing': isUserTabbing,
    });
    return (react_1.default.createElement("div", { className: editableTextClass }, editMode ? (react_1.default.createElement("input", { className: fieldClass, value: editValue, onChange: function (e) { return setEditValue(e.target.value); }, onKeyPress: handleOnKeyPress, onKeyDown: handleOnKeyDown, ref: inputRef, onBlur: handleOnSave, onClick: function (e) { return e.stopPropagation(); } })) : (react_1.default.createElement(ClickableDiv_1.ClickableDiv, tslib_1.__assign({}, clickableDivProps, { className: buttonClass, disabled: disabled || locked, onClick: handleOnEdit, ref: buttonRef, usePointer: true }),
