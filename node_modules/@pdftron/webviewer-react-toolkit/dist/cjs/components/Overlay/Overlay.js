...
function generateOverlayLayer() {
    ...
    return (function (_a) {
        ...
        react_1.useEffect(function () { return add({ className: className }); }, [className]);
        return react_dom_1.createPortal(children, overlayRoot);
    });
}
var Overlay;
...
if (typeof window !== 'undefined') {
    ...
    exports.Overlay = Overlay = function () { return null; };
}
