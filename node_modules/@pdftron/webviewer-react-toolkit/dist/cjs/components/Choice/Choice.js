...
exports.Choice = react_1.forwardRef(function (_a, ref) {
    var label = _a.label, leftLabel = _a.leftLabel, className = _a.className, children = _a.children, id = _a.id, radio = _a.radio, isSwitch = _a.isSwitch, center = _a.center, disabledLabelChange = _a.disabledLabelChange, onChange = _a.onChange, onFocus = _a.onFocus, onBlur = _a.onBlur, props = tslib_1.__rest(_a, ["label", "leftLabel", "className", "children", "id", "radio", "isSwitch", "center", "disabledLabelChange", "onChange", "onFocus", "onBlur"]);
    var inputRef = react_1.useRef(null);
    react_1.useImperativeHandle(ref, function () { return inputRef.current; });
    var isUserTabbing = hooks_1.useAccessibleFocus();
    var _b = hooks_1.useFocus(onFocus, onBlur), focused = _b.focused, handleOnFocus = _b.handleOnFocus, handleOnBlur = _b.handleOnBlur;
    var choiceID = useID_1.useID(id);
    var _c = react_1.useState(function () { var _a, _b, _c; return (_c = (_a = props.checked) !== null && _a !== void 0 ? _a : (_b = inputRef.current) === null || _b === void 0 ? void 0 : _b.checked) !== null && _c !== void 0 ? _c : false; }), checked = _c[0], setChecked = _c[1];
    ...
    var choiceClass = classnames_1.default('ui__base ui__choice', {
    ...
    var inputClass = classnames_1.default('ui__choice__input', {
        'ui__choice__input--switch': isSwitch,
    });
    var checkClass = isSwitch
        ? classnames_1.default('ui__choice__input__switch', {
        ...
        : classnames_1.default('ui__choice__input__check', {
    ...
    var labelClass = classnames_1.default('ui__choice__label', {
        'ui__choice__label--disabled': props.disabled && disabledLabelChange,
    });
    var labelElement = react_1.useMemo(function () {
        if (!label)
            return undefined;
        return (react_1.default.createElement("label", { className: labelClass, htmlFor: choiceID }, label));
    }, [choiceID, label, labelClass]);
    return (react_1.default.createElement("span", { className: choiceClass },
        leftLabel ? labelElement : undefined,
        react_1.default.createElement("span", { className: inputClass },
            isSwitch ? (react_1.default.createElement("div", { className: checkClass },
                react_1.default.createElement("div", { className: "ui__choice__input__toggle" }))) : (react_1.default.createElement("div", { className: checkClass }, checked && !radio ? react_1.default.createElement(Icon_1.Icon, { icon: "Check", className: "ui__choice__input__icon" }) : undefined)),
            react_1.default.createElement("input", tslib_1.__assign({}, props, { id: choiceID, type: radio ? 'radio' : 'checkbox', onChange: handleOnChange, ref: inputRef, onFocus: handleOnFocus, onBlur: handleOnBlur }), children)),
        !leftLabel ? labelElement : undefined));
});
/**
