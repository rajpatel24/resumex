...
exports.Draggable = react_1.forwardRef(function (_a, ref) {
    var index = _a.index, disableDrag = _a.disableDrag, hideDragPreview = _a.hideDragPreview, preventAnimation = _a.preventAnimation, onRenderChildren = _a.onRenderChildren, onMove = _a.onMove, onDragChange = _a.onDragChange, children = _a.children, className = _a.className, divProps = tslib_1.__rest(_a, ["index", "disableDrag", "hideDragPreview", "preventAnimation", "onRenderChildren", "onMove", "onDragChange", "children", "className"]);
    var draggableRef = react_1.useRef(null);
    react_1.useImperativeHandle(ref, function () { return draggableRef.current; });
    ...
    var onDragChangeRef = hooks_1.useCurrentRef(onDragChange);
    react_1.useEffect(function () {
        var _a;
    ...
    /* --- Animation settings. --- */
    var _d = react_1.useState({ x: 0, y: 0 }), coords = _d[0], setCoords = _d[1];
    var prevIndex = react_1.useRef(index);
    var noAnimation = hooks_1.useCurrentRef(isDragging || preventAnimation);
    ...
    react_1.useEffect(function () {
        ...
        var prev = utils_1.getSibling(draggableRef.current, indexDiff);
    ...
    var motionStyle = react_1.useMemo(function () {
        ...
        return {
            x: coords.x === 0 ? react_motion_1.spring(coords.x, SPRING) : coords.x,
            y: coords.y === 0 ? react_motion_1.spring(coords.y, SPRING) : coords.y,
        };
    }, [coords, noAnimation]);
    var draggableClass = classnames_1.default('ui__base ui__draggable', className);
    var onMotionRender = react_1.useCallback(function (_a) {
        var x = _a.x, y = _a.y;
        var inMotion = !!(x || y);
        return (react_1.default.createElement("div", tslib_1.__assign({}, divProps, { ref: draggableRef, className: draggableClass }),
            react_1.default.createElement("div", { style: {
                    WebkitTransform: "translate3d(" + x + "px, " + y + "px, 0)",
                    transform: "translate3d(" + x + "px, " + y + "px, 0)",
                }, className: classnames_1.default('ui__draggable__animated', {
    ...
    return react_1.default.createElement(react_motion_1.Motion, { style: motionStyle }, onMotionRender);
});
