...
var GlobalQueue = /** @class */ (function () {
    ...
    GlobalQueue.prototype.process = function (unit) {
        ...
        this._queueLength++;
        this.flush();
        return [p, function () { return _this.cancel(id); }];
    };
    ...
    GlobalQueue.prototype.cleanup = function () {
        ...
        this.queue = this.queue.filter(function (item) {
            var cancelled = item.cancelled, id = item.id;
            if (cancelled) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (item === null || item === void 0 ? void 0 : item.process())];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
