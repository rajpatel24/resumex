...
function useFileSubscribe(file, getCurrentValue, eventType) {
    ...
    react_1.useEffect(function () {
        ...
        var subscribe = function () {
            ...
            if (val.done) {
                ...
                var r = GlobalQueue_1.default.process(function () { return val.get(); });
                cancel = r[1];
                r[0]
    ...
    return react_1.useMemo(function () { return [value, error, setValue]; }, [error, value]);
}
