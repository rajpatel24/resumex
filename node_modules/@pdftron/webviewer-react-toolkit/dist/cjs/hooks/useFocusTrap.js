...
function useFocusTrap(locked, options) {
    ...
    var lockFocus = react_1.useCallback(function (event) {
    ...
    var checkFocus = react_1.useCallback(function (event) {
        var _a;
    ...
    var focusLastOnUnlockRef = useCurrentRef_1.useCurrentRef(focusLastOnUnlock);
