...
var File = /** @class */ (function () {
    ...
    function File(fileDetails) {
        ...
        this._generateThumbnail = function () { return __awaiter(_this, void 0, void 0, function () {
            var result, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, getThumbnail(this.fullDocumentObj || this.documentObj.get(), {
        ...
        this._generateFileObj = function () {
            return documentToBlob(_this.documentObj.get());
        };
        /** Generate a document object from file object and extension. */
        this._generateDocumentObj = function () {
            return blobToDocument(_this.fileObj.get(), _this.extension, _this._license);
        };
        ...
        this._documentObj = new MemoizedPromise(documentObj !== null && documentObj !== void 0 ? documentObj : this._generateDocumentObj);
        this._fileObj = new MemoizedPromise(fileObj !== null && fileObj !== void 0 ? fileObj : this._generateFileObj);
        this._thumbnail = new MemoizedPromise(thumbnail !== null && thumbnail !== void 0 ? thumbnail : this._generateThumbnail);
    ...
    File.prototype.rotate = function (counterclockwise) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getRotatedDocument(this.documentObj.get(), counterclockwise)];
                    case 1:
                        rotated = _a.sent();
    ...
    File.prototype.clone = function (overrides) {
        var _a = overrides || {}, documentObj = _a.documentObj, rest = __rest(_a, ["documentObj"]);
        return new File(__assign(__assign({ name: this.name, originalName: this.originalName, extension: this.extension }, rest), { documentObj: documentObj || blobToDocument(documentToBlob(this.documentObj.get()), this.extension, this._license) }));
    };
    /* --- Events. --- */
    /**
