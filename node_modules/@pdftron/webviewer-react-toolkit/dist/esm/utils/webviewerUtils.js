...
export var globalLicense = (function () {
    var l = undefined;
    return {
 ...
 */
export function documentToBlob(documentObj) {
    return __awaiter(this, void 0, void 0, function () {
        var fetchedDocument, data, arr;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, documentObj];
                case 1:
 ...
 */
export function blobToDocument(blob, extension, l) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, coreControls.createDocument(fetchedBlob, { extension: extension, l: l || globalLicense.get() })];
                case 3:
                    document_1 = _a.sent();
 ...
 */
export function getRotatedDocument(documentObj, counterclockwise) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    fetchedDocument = (_a.sent());
                    pageNumbers = Array.from({ length: fetchedDocument.getPageCount() }, function (_, k) { return k + 1; });
                    rotation = counterclockwise ? coreControls.PageRotation.E_270 : coreControls.PageRotation.E_90;
                    return [4 /*yield*/, fetchedDocument.rotatePages(pageNumbers, rotation)];
                case 2:
                    _a.sent();
 ...
 */
export function getThumbnail(documentObj, options) {
    var _a;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            extension = options.extension, _b = options.pageNumber, pageNumber = _b === void 0 ? 1 : _b;
            if (extension) {
                supportedFiles = (_a = window.Core) === null || _a === void 0 ? void 0 : _a.SupportedFileFormats.CLIENT;
            ...
            url = function () { return __awaiter(_this, void 0, void 0, function () {
