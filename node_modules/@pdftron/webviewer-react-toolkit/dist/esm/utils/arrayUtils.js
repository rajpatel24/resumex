...
export function moveMultiFromIndexToIndex(prev, moveIds, fromIndex, toIndex) {
    ...
    if (insertionIndex > remaining.length)
        return __spreadArrays(remaining, separated);
    if (insertionIndex < 0)
        return __spreadArrays(separated, remaining);
    return __spreadArrays(remaining.slice(0, insertionIndex), separated, remaining.slice(insertionIndex));
}
